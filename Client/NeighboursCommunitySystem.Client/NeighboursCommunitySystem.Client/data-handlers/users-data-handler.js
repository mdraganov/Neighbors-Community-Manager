var usersData = (function () {
    ...
    function register(user) {
        ...
        return jsonRequester.post('api/user', {
            data: reqUser
        })
          .then(function (resp) {
    ...
    function userUpdateById(id, user) {
        ...
        return jsonRequester.put('api/user/' + id, options)
          .then(function (resp) {
              return resp.result;
          });
    }
    ...
    function userDeleteById(id, user) {
        ...
        return jsonRequester.delete('api/user/' + id, options)
          .then(function (resp) {
              return resp.result;
          });
    }
    ...
    function userDeleteByEmail(email, user) {
        ...
        return jsonRequester.delete('api/user/' + email, options)
          .then(function (resp) {
              return resp.result;
          });
    }
    ...
    function usersGetById(id) {
        return jsonRequester.get('api/user' + id)
          .then(function (res) {
              return res.result;
          });
    }
    ...
    function usersGetByApartmentNumber(number) {
        return jsonRequester.get('api/user' + number)
          .then(function (res) {
              return res.result;
          });
    }
    ...
    function usersGet() {
        return jsonRequester.get('api/user')
          .then(function (res) {
              return res.result;
          });
    }
